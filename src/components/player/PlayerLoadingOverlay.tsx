...
export default function PlayerLoadingOverlay({
  ...
  return (
    <div className='absolute inset-0 z-[500] flex items-center justify-center rounded-ui-md bg-[rgba(var(--ui-bg),0.78)] px-4 backdrop-blur-md transition-opacity duration-300'>
